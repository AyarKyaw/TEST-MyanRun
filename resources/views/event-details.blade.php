...
<!-- Mirrored from themesflat.co/html/zunzo/event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Jan 2026 06:47:40 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
    <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
     <title>MYANRUN| HAPPY HUB FOR RUNNERS</title>
...
.loader-gif {
    ...
    <link href="images/icon/Myan Run icon.png" rel="apple-touch-icon-precomposed" sizes="48x48">
    <link href="images/icon/Myan Run icon.png" rel="apple-touch-icon-precomposed">
    <link href="images/icon/Myan Run icon.png" rel="shortcut icon">
...
<div class="preload preload-container">
    <img src="images/running.gif" alt="Loading" class="loader-gif">
    ...
    <div class="header-top">
        <div class="themeflat-container">
            <div class="header-top-inner">
                <div class="address">
                    <a href="mailto:"><i class="icon-Vector"></i>info@myanrun.com</a>
                    <address><i class="icon-Vector-22"></i>No.68, Htan Ta Pin Street, Aung Myay Thar Si Housing, No(1) Quarter ,Kamaryut, Yangon 11041, Myanmar</address>
                </div>
                <div class="social-icon">
                    <a href="facebook.html"><i class="icon-facebook"></i></a>
                    <a href="instagram.html"><i class="icon-instagram"></i></a>
                    <a href="youtube.html"><i class="icon-youtube"></i></a>
                    <a href="twitter.html"><i class="icon-twitter"></i></a>
                    <a href="pinterest.html"><i class="icon-pinterest"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="header-inner">
                <div id="logo" class="logo">
                    <a href="index.html" rel="home">
                        <img src="images/MyanRun_Orange_RM2.png" alt="image" style="width: 200px; background: transparent;">
                    </a>
                </div><!-- /.logo -->
                <div class="nav-wrap">
                    <div class="btn-menu">
                    ...
                    <nav id="mainnav" class="mainnav">
                        <div id="logo-mobie" class="logo">
                            <a href="index.html" rel="home">
                                <img  src="images/MyanRun_Orange_RM2.png" alt="image">
                            </a>
                        </div><!-- /.logo -->
                        <ul class="menu">
        ...
        <div class="nav-shop-cart ">
            ...
            <div class="widget_shopping_cart_content">
                <div class="minicar-body">
                    ...
                    <ul class="cart_list">
                        <li class="mini_cart_item file-delete-item">
                            <div class="image">
                            ...
                            <div class="title">
                                <a href="shop-detail.html"> Suede leggings</a>
                        ...
                        <li class="mini_cart_item file-delete-item">
                            ...
                            <div class="title">
                                <a href="shop-detail.html"> Contrasting sheepskin...</a>
                                <span class="size">XL/Blue</span>
                            </div>
                            <div class="wrap-remove">
                                <a class="remove-item" href="#">Remove</a>
                        ...
                        <li class="mini_cart_item file-delete-item">
                            ...
                            <div class="title">
                                <a href="shop-detail.html"> Biker-style leggings </a>
                                <span class="size">XL/Blue</span>
                            </div>
                            <div class="wrap-remove">
                                <a class="remove-item" href="#">Remove</a>
                        ...
                        <li class="mini_cart_item file-delete-item">
                            ...
                            <div class="title">
                                <a href="shop-detail.html">Contrasting sheepskin sweatshirt</a>
                                <span class="size">XL/Blue</span>
                            </div>
                            <div class="wrap-remove">
                                <a class="remove-item" href="#">Remove</a>
                ...
                <div class="minicar-footer">
                    ...
                    <div class="view-cart">
                        ...
                        <p class="buttons">
                            <a href="check-out.html" class="button"> Checkout</a>
                            <a href="view-cart.html" class="button checkout">View cart</a>
                        </p>
                        <a href="shop-list.html" class="shopping">Or continue shopping</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="event-detail-box">
                ...
                <div class="detail-box-content">
                    <div class="image-event">
                        <img src="images/evtent/evt2.jpg" alt="Image Events" class="wow fadeInLeft animated">
                    </div>
                    <div class="event-detail-card">
                        <div class="event-detail-container">
                            <h4 class="event-detail-heading">Ticket</h4>
                            <p class="price">
                                <span>80,000 MMK</span>
                                <span class="ticket-price">/ticket</span>
                            </p>
                            <p class="event-title">Yangon Community 10-mile Run 2026 - Run, Connect, Thrive!</p>
                            <div class="event-date-time-or-location">
                                ...
                                <div class="event-date-time">
                                    ...
                                    <p>Start 05:00 AM - Until 10:50 AM</p>
                                </div>
                                <div class="event-date-time">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p>Thuwanna National Indoor Stadium (1)</p>
                                </div>
                            </div>
                            <div class="btn-learn-more">
                                <a href="https://tikkat-customer-uat.onenex.dev/detail/ymcr2026" class="flat-button">Join now</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="event-detail-content">
                        <h3 class="wow fadeInUp animated">Yangon Community 10-mile Run 2026 - Run, Connect, Thrive!</h3>
                        <p class="post wow fadeInUp animated">A community run organized by RUNderful Myanmar in Yangon on 21 March 2026 that expects thousands of runners to take part in three race categories i.e., 10-mile, 5-mile, and 3-mile. The objective of the event is to promote public awareness on regular exercise and running as a lifestyle ultimately to realize the RM’s vision of building up a healthy, active and joyful society centered around athletics, especially running. A beginner-friendly race route starts & ends at Thuwanna Stadium featuring wide and straight paths which is generally flat but flavored with slight uphills and downhills in some sections and stretching along Waizayandar, Thanthumar (up to the Poultry Market area) and Gandamar (up to the Okkla Golf Course area) Roads. This race course could be both reminiscing for seasoned runners and exciting for the beginners as well. RUNderful Myanmar မှ ၂၀၂၆ ခုနှစ် မတ်လ ၂၁ ရက်နေ့တွင် ရန်ကုန်မြို့၌ ကျင်းပမည်ဖြစ်သော လူထုအပြေးပြိုင်ပွဲတွင် အကွာအ၀ေး ၃ မျိုးဖြစ်သည့် ၁၀ မိုင်၊ ၅ မိုင်နှင့် ၃ မိုင်တို့တွင် ထောင်နှင့်ချီသော အပြေးသမား ပါဝင်ယှဉ်ပြိုင်ရန် မျှော်လင့်ထားသည်။ ပွဲ၏ရည်ရွယ်ချက်မှာ ပုံမှန်လေ့ကျင့်ခန်းလုပ်ခြင်း နှင့် အပြေးအားကစားခြင်း တို့ကို ပြည်သူလူထုမှ လူနေမှုပုံစံတရပ်အနေဖြင့် ခံယူကျင့်သုံးလာရန် အသိပညာပေးလှုံဆော်ခြင်းဖြင့် RM ၏ အဓိကမျှော်မှန်းချက်ဖြစ်သော ကျန်းမာသန်စွမ်းပြီး တက်ကြွ ရွှင်လန်းသော လူ့အဖွဲ့အစည်းကို အပြေးအားကစားကို ဗဟိုပြု၍ တည်ဆောက် နိုင်ရန် ဖြစ်သည်။ ယေဘုယျအားဖြင့် ကျယ်ဝန်းပြီး ဖြောင့်တန်းသောလမ်းများပါရှိသော သုဝဏ္ဏအားကစားကွင်းမှ တာထွက်၍ သုဝဏ္ဏအားကစားကွင်းတွင်ပင် ပန်း၀င်မည့် ပြိုင်ပွဲလမ်းကြောင်းသည် အချို့အပိုင်းများတွင် အတက်၊ အဆင်းများရှိပြီး ဝေဇယန္တာ၊ သံသုမာ (ကြက်ဘဲဈေးဧရိယာအထိ) နှင့် ဂန္ဓမာ (ဥက္ကလာဂေါက်ကွင်းအထိ) လမ်းများပါ၀င်ပါသည်။ ဤပြေးလမ်းသည် ၀ါရင့် အပြေး သမားများ အတွက် ယခင် ရန်ကုန်လူထုပြေးပွဲများနှင့်ပတ်သက်၍ သတိရအောက်မေ့ဖွယ်ရာများ ရှိမှာဖြစ်ပြီး ယခုမှစတင်ပြေးသူများအတွက်လည်း စိတ်လှုပ်ရှားဖွယ်ရာ ဖြစ်ပါလိမ့်မည်။</p>
                        <ul>
                        ...
                        <a href="contact.html" class="flat-button wow fadeInUp animated">Register now</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="image-event-content">
                        <img src="images/evtent/evt1.jpg" alt="" class="wow fadeInRight animated">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-6 pd-form">
                        <div class="form-contact background-black">
                            ...
                            <ul class="social-media">
                                ...
                                <li>
                                    <a href="dribbble.html"><i class="icon-dribbble"></i></a>
                                </li>
                                <li>
                                    <a href="behance.html"><i class="icon-behance"></i></a>
                                </li>
                                <li>
                                    <a href="pinterest.html"><i class="icon-pinterest"></i></a>
                                </li>
                        ...
                        <div class="widget">
                            <div class="textwidget">
                                ...
                                <div class="social-icon-footer">
                                    <a href="facebook.html"><i class="icon-facebook"></i></a>
                                    <a href="linkedin.html"><i class="icon-linkedin2"></i></a>
                                    <a href="twitter.html"><i class="icon-twitter"></i></a>
                                    <a href="instagram.html"><i class="icon-instagram"></i></a>
                                    <a href="youtube.html"><i class="icon-youtube"></i></a>
                        ...
                        <div class="widget widget_text widget_menu-footer">
                            ...
                            <div class="menu-footer">
                                <div class="text-phone">
                                    ...
                                    <div class="address">
                                        <p>Need help? 24/7</p>
                                        <span>+95 95056924</span>
                                    </div>
                                </div>
                                <p><i class="icon-MapPin"></i>No.961, Thanthumar Road, 14 Qtr, South Oakalarpa Township, Yangon, Myanmar</p>
                                <form action="#">
...
<!-- Mirrored from themesflat.co/html/zunzo/event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Jan 2026 06:47:43 GMT -->
</html>
