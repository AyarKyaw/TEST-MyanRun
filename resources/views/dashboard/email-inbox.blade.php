...
<!-- Mirrored from tixia-html.vercel.app/email-inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:06 GMT -->
...
<!-- End - Sidebar -->
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Email Inbox</li>
				...
				<div class="card border-0 rounded-0 mb-0 h-auto">
                       ...
                       <div class="row gx-0">
                            ...
                            <div class="col-xxl-2 col-xl-3 col-lg-4 email-left-body">
								<div class="email-left-column dz-scroll" id="email-left">
									<div class="mb-4">
										<a href="email-compose.html" class="btn btn-lg btn-primary w-100"><i class="fa-solid fa-plus"></i> Compose Email</a>
									</div>
							...
							<div class="col-xxl-10 col-xl-9 col-lg-8">
								<div class="email-right-column check-wrapper">
									<div class="d-sm-flex align-items-center justify-content-between px-3 border-bottom">
										<div class="d-flex justify-content-between py-3 py-sm-2 order-1">
											<div class="d-flex gap-1">
												<a href="javascript:void(0);" class="btn btn-square btn-sm tp-btn-light btn-primary">
													<i class="fa fa-archive"></i>
												</a>
												<a href="javascript:void(0);" class="btn btn-square btn-sm tp-btn-light btn-primary">
													<i class="fa fa-exclamation-circle"></i>
												</a>
												<a href="javascript:void(0);" class="btn btn-square btn-sm tp-btn-light btn-danger">
													<i class="fa fa-trash"></i>
												</a>
												<a href="javascript:void(0);" class="btn btn-square btn-sm tp-btn-light btn-warning">
												...
												<div class="dropdown">
													...
													<ul class="dropdown-menu dropdown-menu-end">
														<li><a class="dropdown-item" href="javascrip:void(0);">Mark as Unread</a></li>
														<li><a class="dropdown-item" href="javascrip:void(0);">Add to Tasks</a></li>
														<li><a class="dropdown-item" href="javascrip:void(0);">Add Star</a></li>
														<li><a class="dropdown-item" href="javascrip:void(0);">Mute</a></li>
													</ul>
												</div>
											</div>
											<div class="d-block d-lg-none">
												<a href="javascript:void(0);" class="mobile-email-panel btn btn-square btn-sm tp-btn-light btn-primary">
										...
										<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
											<div class="email-list dz-scroll" id="emails">
												...
												<div class="message unread">
													<div class="message-single">
														<div class="email-checkbox form-check custom-checkbox">
															<input type="checkbox" class="form-check-input" id="emailCheckbox14">
														</div>
														<label class="bookmark-btn">
															<input type="checkbox">
															<span class="checkmark"></span>
									...
									<div class="d-flex justify-content-between align-items-center bg-light px-3 py-2">
										<small>Showing 1-5 from 100 data</small>
										<nav aria-label="Email Inbox Pagination">
											<ul class="pagination pagination-gutter pagination-sm">
