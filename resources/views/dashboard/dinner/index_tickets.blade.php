...
<style>
    ...
    .section-header {
        ...
        border-radius: 15px; margin-bottom: 25px; border-left: 5px solid #22c55e;
...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="section-header">
            <div>
                <h3 class="font-weight-bold mb-0" style="color: #166534;"><i class="fas fa-bolt mr-2"></i> ACTIVE DINNERS</h3>
                <small class="text-muted text-uppercase font-weight-bold">Currently open for registrations</small>
            </div>
            <div class="ml-auto"><span class="badge badge-success px-3 py-2">LIVE</span></div>
        </div>
        ...
        <div class="row">
            ...
            @empty
                <div class="col-12 text-center py-5">
                    <p class="text-muted">No active dinners at the moment.</p>
                </div>
            @endforelse
        </div>
        ...
        <div class="past-container">
            <div class="section-header past">
                <div><h3 class="font-weight-bold mb-0 text-secondary"><i class="fas fa-history mr-2"></i> PAST DINNERS</h3></div>
            ...
            <div class="row">
                ...
                @empty
                    <div class="col-12 text-center py-5"><p class="text-muted italic">No past events.</p></div>
                @endforelse
            </div>
        </div>
    </div>
