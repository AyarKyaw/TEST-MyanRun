...
<!-- Mirrored from tixia-html.vercel.app/chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:16 GMT -->
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item">
                        <select class="selectpicker form-select i18n-select" id="langSwitcher">
                            ...
                            <option value="pt_BR" title="Portuguese" data-content="<img src='assets/images/flags/pt.svg' alt=''> Português">Português</option>
                            <option value="fr_FR" title="French" data-content="<img src='assets/images/flags/fr.svg' alt=''> Français">Français</option>
                            <option value="de_DE" title="German" data-content="<img src='assets/images/flags/de.svg' alt=''> Deutsch">Deutsch</option>
                            <option value="it_IT" title="Italian" data-content="<img src='assets/images/flags/it.svg' alt=''> Italiano">Italiano</option>
                            <option value="jp_JP" title="Japanese" data-content="<img src='assets/images/flags/jp.svg' alt=''> 日本語">日本語</option>
                            <option value="es_ES" title="Spanish" data-content="<img src='assets/images/flags/es.svg' alt=''> Español">Español</option>
                            <option value="ar_TN" title="Arabic" data-content="<img src='assets/images/flags/arab.svg' alt=''> العربية">العربية</option>
                            <option value="tr_TR" title="Turkish" data-content="<img src='assets/images/flags/tr.svg' alt=''> Türkçe">Türkçe</option>
                        </select>
                    </li>
                    <li class="nav-item dropdown notification_dropdown">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            <img src="assets/images/profile/pic1.webp" width="20" alt="">
                        </a>
        ...
        <ul class="metismenu" id="menu">
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="index-dark.html" data-i18n="Dashboard Dark">Dashboard Dark</a></li>
                    ...
                    <li><a href="customer-list.html" data-i18n="Customer List">Customer List</a></li>
                    <li><a href="reviews.html" data-i18n="Reviews">Reviews</a></li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="create-ticket.html" data-i18n="Create Ticket">Create Ticket</a></li>
                    <li><a href="all-ticket.html" data-i18n="All Ticket">All Ticket</a></li>
                </ul>
            </li>
            <li>
                <a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="customers-list.html" data-i18n="Customers List">Customers List</a></li>
                    <li><a href="add-customers.html" data-i18n="Add Customers">Add Customers</a></li>
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="pages/page-register.html" data-i18n="Register">Register</a></li>
                    <li><a href="pages/page-login.html" data-i18n="Login">Login</a></li>
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false" data-i18n="Error">Error</a>
                        <ul aria-expanded="false">
                            <li><a href="pages/page-error-400.html" data-i18n="Error 400">Error 400</a></li>
                            <li><a href="pages/page-error-403.html" data-i18n="Error 403">Error 403</a></li>
                            <li><a href="pages/page-error-404.html" data-i18n="Error 404">Error 404</a></li>
                            <li><a href="pages/page-error-500.html" data-i18n="Error 500">Error 500</a></li>
                            <li><a href="pages/page-error-503.html" data-i18n="Error 503">Error 503</a></li>
                        </ul>
                    </li>
                    <li><a href="pages/page-lock-screen.html" data-i18n="Lock Screen">Lock Screen</a></li>
                </ul>
            </li>
        </ul>
    </div>
...
<!-- End - Sidebar -->
       ...
       <!-- Start - Content Body -->
        <main class="content-body chat-height">
                        ...
                        <div class="card overflow-hidden full-chatbox-wrapper">
                            <div class="card-body p-0">
								<div class="row gx-0">
									<div class="col-xl-3 col-lg-5 chat-border chat-left-area">
										...
										<div class="p-3 bg-body">
											<div class="position-relative">
												...
												<a href="javascript:void(0);" class="btn btn-square btn-sm send-btn position-absolute end-0 top-50 translate-middle-y me-3">
													<svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
														<circle cx="8.82495" cy="9.32491" r="6.74142" stroke="var(--bs-body-color)" stroke-linecap="round" stroke-linejoin="round"/>
														<path d="M13.5137 14.3638L16.1568 16.9999" stroke="var(--bs-body-color)" stroke-linecap="round" stroke-linejoin="round"/>
													</svg>
												</a>
											</div>
										</div>
										<div class="p-2 dz-scroll chat-users">
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												...
												<div class="clearfix ms-2">
													<h6 class="fs-13 mb-0 fw-semibold">Oliver Noah</h6>
													<span class="fs-13">Good morning!</span>
												</div>
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												...
												<div class="clearfix ms-2">
													<h6 class="fs-13 mb-0 fw-semibold">Amelia Rose</h6>
													<span class="fs-13">Got it!</span>
												</div>
												<div class="clearfix ms-auto">
													<small>2 MIN</small>
												</div>
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												...
												<div class="clearfix ms-2">
													<h6 class="fs-13 mb-0 fw-semibold">Elijah James</h6>
													<span class="fs-13">Welcome back</span>
												</div>
												<div class="clearfix ms-auto">
													<small>5 MIN</small>
												</div>
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												...
												<div class="clearfix ms-2">
													...
													<span class="fs-13">I'm looking to spend</span>
												</div>
												<div class="clearfix ms-auto">
													<small>5 MIN</small>
												</div>
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												<div class="d-inline-block position-relative">
													<img src="assets/images/avatar/small/avatar10.webp" alt="" class="rounded-circle avatar avatar-sm">
													<span class="fa fa-circle text-success position-absolute bottom-0 end-0 border border-2 border-white rounded-circle fs-8"></span>
												</div>
												<div class="clearfix ms-2">
													<h6 class="fs-13 mb-0 fw-semibold">William Jasper</h6>
													<span class="fs-13">we have a great</span>
												</div>
												<div class="clearfix ms-auto">
													<small>1 MIN</small>
												</div>
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												<div class="d-inline-block position-relative">
													<img src="assets/images/avatar/small/avatar9.webp" alt="" class="rounded-circle avatar avatar-sm">
												</div>
												<div class="clearfix ms-2">
													<h6 class="fs-13 mb-0 fw-semibold">Harper Joy</h6>
													<span class="fs-13">Welcome back</span>
												</div>
												<div class="clearfix ms-auto">
													<small>2 MIN</small>
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												<div class="d-inline-block position-relative">
													<img src="assets/images/avatar/small/avatar8.webp" alt="" class="rounded-circle avatar avatar-sm">
													<span class="fa fa-circle text-success position-absolute bottom-0 end-0 border border-2 border-white rounded-circle fs-8"></span>
												</div>
												<div class="clearfix ms-2">
													<h6 class="fs-13 mb-0 fw-semibold">Alexander Finn</h6>
													<span class="fs-13">Welcome back</span>
												</div>
												<div class="clearfix ms-auto">
													<small>5 MIN</small>
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												<div class="d-inline-block position-relative">
													<img src="assets/images/avatar/small/avatar7.webp" alt="" class="rounded-circle avatar avatar-sm">
													<span class="fa fa-circle text-success position-absolute bottom-0 end-0 border border-2 border-white rounded-circle fs-8"></span>
												</div>
												<div class="clearfix ms-2">
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												<div class="d-inline-block position-relative">
													<img src="assets/images/avatar/small/avatar6.webp" alt="" class="rounded-circle avatar avatar-sm">
													<span class="fa fa-circle text-success position-absolute bottom-0 end-0 border border-2 border-white rounded-circle fs-8"></span>
												</div>
												<div class="clearfix ms-2">
													<h6 class="fs-13 mb-0 fw-semibold">Jackson Miles</h6>
													<span class="fs-13">Welcome back</span>
												</div>
												<div class="clearfix ms-auto">
													<small>1 MIN</small>
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												<div class="d-inline-block position-relative">
													<img src="assets/images/avatar/small/avatar5.webp" alt="" class="rounded-circle avatar avatar-sm">
												</div>
												<div class="clearfix ms-2">
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded">
												...
												<div class="clearfix ms-2">
													<h6 class="fs-13 mb-0 fw-semibold">Liam Risher</h6>
													<span class="fs-13">Welcome back</span>
												</div>
												<div class="clearfix ms-auto">
													<small>1 MIN</small>
									...
									<div class="col-xl-5 col-lg-7 border-start flex-column d-flex">
										<div class="d-flex justify-content-between p-3 border-bottom">
											<div class="d-flex">
												<img src="assets/images/avatar/small/avatar4.webp" class="avatar avatar-sm rounded-circle" alt="">
												<div class="ms-2">
													<h6 class="mb-0">Oliver Noah </h6>
													<small class="d-flex align-items-center"><i class="fa-solid fa-circle text-success me-1 fs-8"></i> online</small>
												</div>	
											</div>
											<div class="clearfix">
												<a href="javascript:void(0);" class="btn btn-square btn-success btn-sm ms-1">
												...
												<a href="javascript:void(0);" class="btn btn-square btn-primary btn-sm ms-1">
										...
										<div class="p-3 chatbox-wrapper">
											<div class="chatbox-content dz-scroll">
												<span class="chat-date">27 Feb 2024</span>
												<div class="chat-content-left">
													<div class="message-item">
														<div class="bubble">Good morning!</div>    
														<div class="bubble"> I'm looking for a new laptop</div>     
												...
												<div class="chat-content-right">
													<div class="message-item">
														<div class="bubble">Good morning!</div>    
														<div class="bubble">Of course, we have a great selection of laptops.</div>     
														<div class="message-time">10:30 am</div>    
													</div>
												</div>
												<div class="chat-content-left">
													<div class="message-item">
														<div class="bubble">I'm looking to spend around $800 to $1,000.</div>    
														<div class="message-time">10:30 am</div>    
													</div>
												</div>
												...
												<div class="chat-content-right">
													<div class="message-item">
														<div class="bubble"> Got it!</div>    
														<div class="bubble">We have several options that would suit your needs. Let me show you a few models that match your criteria.</div>
														<div class="message-time">10:30 am</div>    
													</div>
												</div>
											</div>
											<div class="chatbox-footer">
												<div class="input-wrapper mb-2">
													<input type="text" class="form-control form-control-lg bg-light border-0" placeholder="Hello honey risher..." style="padding-right: 100px;">
													<a href="javascript:void(0);" class="btn btn-primary send-btn position-absolute end-0 top-50 translate-middle-y me-1">
									...
									<div class="col-xl-4 border-start">
										<hr class="d-block m-0 d-xl-none">
										<div class="p-3">
											<h5>Media</h5>
											<div class="d-flex flex-wrap gap-2">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar1.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar3.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar5.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar7.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar9.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar10.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar8.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar6.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar4.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar2.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar3.webp" alt="">
												<img class="avatar rounded-1" src="assets/images/avatar/small/avatar4.webp" alt="">
											</div>
										</div>
										<div class="p-3">
											...
											<div>
												<div class="row g-1">
													<div class="col-xxl-4 col-xl-6 col-lg-3 col-sm-4 col-6">
														<a href="javascript:void(0);" class="text-center px-2 py-3 bg-action-primary rounded text-body d-block">
															<img src="assets/images/chat/google-docs1.avif" height="35" alt="" class="mb-2">
															<h6 class="mb-0">index.html</h6>
															<small>3 Items December 27th, 2021 04:56 AM - 10.0 MB</small>
														</a>
													</div>
													<div class="col-xxl-4 col-xl-6 col-lg-3 col-sm-4 col-6">
														<a href="javascript:void(0);" class="text-center px-2 py-3 bg-action-primary rounded text-body d-block">
															<img src="assets/images/chat/play-button1.avif" height="35" alt="" class="mb-2">
															<h6 class="mb-0">video.mp4</h6>
															<small>3 Items December 27th, 2021 04:56 AM - 10.0 MB</small>
														</a>
													</div>
													<div class="col-xxl-4 col-xl-6 col-lg-3 col-sm-4 col-6">
														<a href="javascript:void(0);" class="text-center px-2 py-3 bg-action-primary rounded text-body d-block">
															<img src="assets/images/chat/music-notes1.avif" height="35" alt="" class="mb-2">
															<h6 class="mb-0">songs.mp4</h6>
															<small>3 Items December 27th, 2021 04:56 AM - 10.0 MB</small>
														</a>
													</div>
													<div class="col-xxl-4 col-xl-6 col-lg-3 col-sm-4 col-6">
														<a href="javascript:void(0);" class="text-center px-2 py-3 bg-action-primary rounded text-body d-block">
															<img src="assets/images/chat/pdf.avif" alt="" height="35" class="mb-2">
													...
													<div class="col-xxl-4 col-xl-6 col-lg-3 col-sm-4 col-6">
														<a href="javascript:void(0);" class="text-center px-2 py-3 bg-action-primary rounded text-body d-block">
															<img src="assets/images/chat/google-docs1.avif" height="35" alt="" class="mb-2">
															<h6 class="mb-0">screenshot.text</h6>
															<small>3 Items December 27th, 2021 04:56 AM - 10.0 MB</small>
														</a>
													</div>
												</div>
...
<!-- Mirrored from tixia-html.vercel.app/chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:18 GMT -->
</html>