...
<!-- Mirrored from tixia-html.vercel.app/ecom-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:31 GMT -->
                                        ...
                                        <ul class="list-group mb-3">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between bg-primary">
                                                <div>
                                                    ...
                                                    <small class="text-white">EXAMPLECODE</small>
                                                </div>
                                        ...
                                        <form class="needs-validation" novalidate>
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <select class="selectpicker form-select" id="country" required>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="selectpicker form-select" id="state" required>
                                                        <option value="">Choose...</option>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="number" class="form-control type-number" id="zip" placeholder="" required="">
                                            ...
                                            <div class="row gy-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" class="form-control type-number" id="cc-number" placeholder="" required="">
