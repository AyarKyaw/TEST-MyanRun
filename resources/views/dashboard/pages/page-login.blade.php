...
<!-- Mirrored from tixia-html.vercel.app/pages/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:40 GMT -->
                            ...
                            <form action="http://../index.html">
                                ...
                                <div class="form-row d-flex flex-wrap justify-content-between align-items-baseline mb-2">
                                    ...
                                    <div class="form-group ms-2">
                                        <a href="http://../pages/page-forgot-password.html">Forgot Password?</a>
										
                                    </div>
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary btn-block w-100 fs-16">Sign In</button>
                                </div>
                            </form>
                            <div class="new-account mt-3">
                                <p>Don't have an account? <a class="text-primary" href="http://../pages/page-register.html">Sign up</a></p>
                            </div>
                        </div>
                    </div>
                </div>
