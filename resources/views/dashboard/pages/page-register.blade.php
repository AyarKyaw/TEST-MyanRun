...
<!-- Mirrored from tixia-html.vercel.app/pages/page-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:40 GMT -->
                    ...
                    <div class="auth-form">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <a href="http://../index.html"><img class="logo-auth" src="http://../assets/images/logo-full.avif" width="200" alt=""></a>
                            </div>
                            <h4 class="text-center mb-4">Sign up your account</h4>
                            <form action="http://../index.html">
                                <div class="form-group mb-4">
                                    <label class="form-label" for="username">Username</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Enter username" id="username">
                                </div>
                                <div class="form-group mb-4">
                                    <label class="form-label" for="email">Email</label>
                                    <input type="email" class="form-control form-control-sm" placeholder="hello@example.com" id="email">
                                </div>
                                <div class="mb-3">
									<label class="form-label">Password</label>
									<div class="position-relative">
										<input type="password" autocomplete="current-password" class="form-control form-control-sm dz-password" placeholder="Enter your password">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary btn-block w-100 fs-16">Sign up</button>
                                </div>
                            </form>
                            <div class="new-account mt-3">
                                <p>Already have an account? <a class="text-primary" href="http://../pages/page-login.html">Sign in</a></p>
                            </div>
                        </div>
                    </div>
                </div>
