...
<!-- Mirrored from tixia-html.vercel.app/profile/projects-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:11 GMT -->
				...
				<div class="card h-auto px-md-2 pt-md-2">
					...
					<div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center mx-sm-4 px-0">
						<ul class="nav nav-underline gap-3 nav-scroll nav-scroll-auto-xl px-3 px-sm-0" id="tabMyProfileBottom" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<a href="http://../profile/projects.html" class="nav-link py-3 px-1 border-3 active">Projects</a>
							</li>
							<li class="nav-item" role="presentation">
				...
				<div class="tab-content" id="tabContentMyProfileBottom">
					<div class="d-flex justify-content-between align-items-center mb-3">
						...
						<div class="d-flex align-items-center">
							<a href="http://../profile/projects.html" class="btn-link ms-2">More Project</a>
						</div>
					</div>
					<div class="row">
									...
									<div class="clearfix">
										...
										<div class="clearfix d-flex">
											...
											<div class="chart-series" id="seriesComple">
												<svg width="8" height="3" viewBox="0 0 8 3" fill="none" xmlns="http://www.w3.org/2000/svg">
													<rect width="8" height="3" rx="1.5" fill="var(--bs-primary)"/>
												</svg>
												<input class="d-none" type="checkbox" id="checkSeriesComple" name="chart-series" value="Comple">
												<label class="mb-0" for="checkSeriesComple">Complete</label>
											</div>
										</div>
									</div>
									<div class="clearfix">
								...
								<div class="card-body px-3 py-3">
									<div class="d-flex align-items-center p-2 bg-action-light rounded">
										<div class="d-inline-block position-relative">
											<img src="http://../assets/images/avatar/small/avatar6.webp" alt="" class="rounded-circle avatar avatar-sm">
											<span class="fa fa-circle text-success position-absolute bottom-0 end-0 border border-2 border-white rounded-circle fs-8"></span>
										</div>
										<div class="clearfix ms-3">
											<h6 class="fs-13 mb-0 fw-semibold">Henry Mason</h6>
											<span class="fs-13">8 Pending & 97 Completed Tasks</span>
										</div>
										<div class="clearfix ms-auto">
											<span class="badge badge-sm light badge-primary">8</span>
										</div>
									</div>
									<div class="d-flex align-items-center p-2 bg-action-light rounded">
										<div class="d-inline-block position-relative">
											<img src="http://../assets/images/avatar/small/avatar5.webp" alt="" class="rounded-circle avatar avatar-sm">
											<span class="fa fa-circle text-success position-absolute bottom-0 end-0 border border-2 border-white rounded-circle fs-8"></span>
										</div>
										<div class="clearfix ms-3">
											<h6 class="fs-13 mb-0 fw-semibold">Isabella Claire</h6>
											<span class="fs-13">8 Pending & 97 Completed Tasks</span>
										</div>
										<div class="clearfix ms-auto">
											<span class="badge badge-sm light badge-primary">6</span>
										</div>
									</div>
									<div class="d-flex align-items-center p-2 bg-action-light rounded">
										<div class="avatar avatar-sm avatar-success rounded-circle">E</div>
										<div class="clearfix ms-3">
											<h6 class="fs-13 mb-0 fw-semibold">Evelyn Hope</h6>
											<span class="fs-13">8 Pending & 97 Completed Tasks</span>
										</div>
										<div class="clearfix ms-auto">
											<span class="badge badge-sm light badge-primary">7</span>
										</div>
									</div>
									<div class="d-flex align-items-center p-2 bg-action-light rounded">
										<div class="d-inline-block position-relative">
											<img src="http://../assets/images/avatar/small/avatar4.webp" alt="" class="rounded-circle avatar avatar-sm">
											<span class="fa fa-circle text-danger position-absolute bottom-0 end-0 border border-2 border-white rounded-circle fs-8"></span>
										</div>
										<div class="clearfix ms-3">
											<h6 class="fs-13 mb-0 fw-semibold">William Jasper</h6>
											<span class="fs-13">8 Pending & 97 Completed Tasks</span>
										</div>
										<div class="clearfix ms-auto">
											<span class="badge badge-sm light badge-primary">5</span>
										</div>
									</div>
									<div class="d-flex align-items-center p-2 bg-action-light rounded">
										<div class="d-inline-block position-relative">
										...
										<div class="clearfix ms-3">
											<h6 class="fs-13 mb-0 fw-semibold">Scarlett Elise</h6>
											<span class="fs-13">8 Pending & 97 Completed Tasks</span>
										</div>
										<div class="clearfix ms-auto">
											<span class="badge badge-sm light badge-primary">3</span>
										</div>
									</div>
									<div class="d-flex align-items-center p-2 bg-action-light rounded">
										<div class="d-inline-block position-relative">
										...
										<div class="clearfix ms-3">
											<h6 class="fs-13 mb-0 fw-semibold">Emily Kate</h6>
											<span class="fs-13">8 Pending & 97 Completed Tasks</span>
										</div>
										<div class="clearfix ms-auto">
											<span class="badge badge-sm light badge-primary">6</span>
								...
								<div class="card-body">
									<div class="d-flex align-items-center py-2">
										...
										<div class="clearfix ms-2">
											...
											<span class="small">Due in 1 day <span class="text-primary">Olivia Grace</span></span>
										</div>
										<div class="clearfix ms-auto">
											<button type="button" class="btn btn-sm btn-light btn-square"><i class="bi bi-grid"></i></button>
										</div>
									...
									<div class="d-flex align-items-center py-2">
										...
										<div class="clearfix ms-2">
											...
											<span class="small">Due in 3 days <span class="text-primary">Liam Risher</span></span>
										</div>
										<div class="clearfix ms-auto">
											<button type="button" class="btn btn-sm btn-light btn-square"><i class="bi bi-grid"></i></button>
										</div>
									...
									<div class="d-flex align-items-center py-2">
										...
										<div class="clearfix ms-2">
											...
											<span class="small">Due in 1 week <span class="text-primary">Scarlett Elise</span></span>
										</div>
										<div class="clearfix ms-auto">
											<button type="button" class="btn btn-sm btn-light btn-square"><i class="bi bi-grid"></i></button>
										</div>
									...
									<div class="d-flex align-items-center py-2">
										...
										<div class="clearfix ms-2">
											...
											<span class="small">Due in 1 week <span class="text-primary">Elijah James</span></span>
										</div>
										<div class="clearfix ms-auto">
											<button type="button" class="btn btn-sm btn-light btn-square"><i class="bi bi-grid"></i></button>
										</div>
									...
									<div class="d-flex align-items-center py-2">
										...
										<div class="clearfix ms-2">
											...
											<span class="small">Due in 2 weeks <span class="text-primary">Alexander Finn</span></span>
										</div>
										<div class="clearfix ms-auto">
											<button type="button" class="btn btn-sm btn-light btn-square"><i class="bi bi-grid"></i></button>
										</div>
									...
									<div class="d-flex align-items-center py-2">
										...
										<div class="clearfix ms-2">
											<h6 class="fs-13 mb-0 fw-semibold">Create FureStibe branding logo</h6>
											<span class="small">Due in 1 day <span class="text-primary">Sophia Jane</span></span>
										</div>
										<div class="clearfix ms-auto">
											<button type="button" class="btn btn-sm btn-light btn-square"><i class="bi bi-grid"></i></button>
										</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="d-flex align-items-center py-2">
										<div class="d-flex align-items-center">
											<div class="me-2">
												<img src="http://../assets/images/files/pdf.avif" width="32" alt="">
											</div>
											<div class="clearfix">
												<h6 class="fs-13 mb-0 fw-semibold">Project tech requirements</h6>
												<span class="small">2 days ago <span class="text-primary">Liam Risher</span></span>
											</div>
										</div>
										<div class="clearfix ms-auto">
											<button type="button" class="btn btn-sm btn-light btn-square"><i class="bi bi-grid"></i></button>
									...
									<div class="d-flex align-items-center py-2">
										<div class="d-flex align-items-center">
											<div class="me-2">
												<img src="http://../assets/images/files/css.avif" width="32" alt="">
											</div>
											<div class="clearfix">
												<h6 class="fs-13 mb-0 fw-semibold">Create FureStibe branding logo</h6>
												<span class="small">Due in 1 day <span class="text-primary">Sophia Jane</span></span>
									...
									<div class="d-flex align-items-center py-2">
										<div class="d-flex align-items-center">
											<div class="me-2">
												<img src="http://../assets/images/files/csv.avif" width="32" alt="">
											</div>
											<div class="clearfix">
												<h6 class="fs-13 mb-0 fw-semibold">Create FureStibe branding logo</h6>
												<span class="small">Due in 1 day <span class="text-primary">Abigail Faith </span></span>
											</div>
										</div>
										<div class="clearfix ms-auto">
											<button type="button" class="btn btn-sm btn-light btn-square"><i class="bi bi-grid"></i></button>
									...
									<div class="d-flex align-items-center py-2">
										<div class="d-flex align-items-center">
											<div class="me-2">
												<img src="http://../assets/images/files/mp3.avif" width="32" alt="">
											</div>
											<div class="clearfix">
												<h6 class="fs-13 mb-0 fw-semibold">Create FureStibe branding logo</h6>
												<span class="small">Due in 1 day <span class="text-primary">Amelia Rose</span></span>
											</div>
										</div>
										<div class="clearfix ms-auto">
											<button type="button" class="btn btn-sm btn-light btn-square"><i class="bi bi-grid"></i></button>
								...
								<div class="card-footer border-0 pt-0">
									<div class="alert alert-primary outline-dashed border-2 py-3 px-3 d-flex align-items-center mb-0">
										<svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path opacity="0.25" d="M4.125 5.5C4.125 3.22183 5.97183 1.375 8.25 1.375H21.6664C22.7604 1.375 23.8096 1.8096 24.5832 2.58318L27.6668 5.66682C28.4404 6.4404 28.875 7.48961 28.875 8.58363V27.5C28.875 29.7782 27.0282 31.625 24.75 31.625H8.25C5.97183 31.625 4.125 29.7782 4.125 27.5V5.5Z" fill="var(--bs-primary)"/>
											<path d="M20.625 2.60123C20.625 1.924 21.174 1.375 21.8512 1.375C22.8269 1.375 23.7626 1.76258 24.4525 2.45247L27.7975 5.79753C28.4874 6.48742 28.875 7.42312 28.875 8.39877C28.875 9.076 28.326 9.625 27.6488 9.625H22C21.2406 9.625 20.625 9.00939 20.625 8.25V2.60123Z" fill="var(--bs-primary)"/>
											<path d="M15.9737 12.4793C15.8115 12.5464 15.6596 12.6459 15.5277 12.7777L11.4027 16.9027C10.8658 17.4397 10.8658 18.3103 11.4027 18.8473C11.9397 19.3842 12.8103 19.3842 13.3473 18.8473L15.125 17.0695V23.375C15.125 24.1344 15.7406 24.75 16.5 24.75C17.2594 24.75 17.875 24.1344 17.875 23.375V17.0695L19.6527 18.8473C20.1897 19.3842 21.0603 19.3842 21.5973 18.8473C22.1342 18.3103 22.1342 17.4397 21.5973 16.9027L17.4723 12.7777C17.0671 12.3726 16.4721 12.2731 15.9737 12.4793Z" fill="var(--bs-primary)"/>
										</svg>
										<div class="mx-3">
											<h6 class="fw-semibold mb-0">Quick file uploader</h6>
											<p class="mb-0">Drag & Drop or choose files from computer</p>
										</div>
									</div>
								</div>
							</div>
