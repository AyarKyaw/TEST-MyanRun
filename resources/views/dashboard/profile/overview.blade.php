...
<!-- Mirrored from tixia-html.vercel.app/profile/overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:11 GMT -->
...
<head>
	...
	<meta property="og:image" content="../../tixia.dexignzone.com/xhtml/social-image.png">
	...
	<meta name="twitter:image" content="../../tixia.dexignzone.com/xhtml/social-image.png">
	...
	<!-- Start - CANONICAL URL -->
	<link rel="canonical" href="https://tixia.dexignzone.com/xhtml/index.html">
	<!-- End - CANONICAL URL -->

    <!-- Start - Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="http://../assets/images/favicon.avif">
	<!-- End - Favicon icon -->
...
<div class="nav-header">
    <a href="http://../index.html" class="brand-logo">
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="http://../assets/images/avatar/small/avatar1.webp" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="http://../assets/images/avatar/small/avatar2.webp" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="http://../assets/images/avatar/small/avatar3.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="http://../assets/images/avatar/small/avatar4.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="http://../assets/images/avatar/small/avatar5.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz- -user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="http://../assets/images/avatar/small/avatar6.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="http://../assets/images/avatar/small/avatar7.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="http://../assets/images/avatar/small/avatar8.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="http://../assets/images/avatar/small/avatar9.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="http://../assets/images/avatar/small/avatar10.webp" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="http://../assets/images/avatar/small/avatar1.webp" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
										<img src="http://../assets/images/avatar/small/avatar2.webp" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item">
                        <select class="selectpicker form-select i18n-select" id="langSwitcher">
                            <option value="en_GB" title="English" data-content="<img src='http://../assets/images/flags/gb-eng.svg' alt=''> English">English</option>
                            <option value="pt_BR" title="Portuguese" data-content="<img src='http://../assets/images/flags/pt.svg' alt=''> Português">Português</option>
                            <option value="fr_FR" title="French" data-content="<img src='http://../assets/images/flags/fr.svg' alt=''> Français">Français</option>
                            <option value="de_DE" title="German" data-content="<img src='http://../assets/images/flags/de.svg' alt=''> Deutsch">Deutsch</option>
                            <option value="it_IT" title="Italian" data-content="<img src='http://../assets/images/flags/it.svg' alt=''> Italiano">Italiano</option>
                            <option value="jp_JP" title="Japanese" data-content="<img src='http://../assets/images/flags/jp.svg' alt=''> 日本語">日本語</option>
                            <option value="es_ES" title="Spanish" data-content="<img src='http://../assets/images/flags/es.svg' alt=''> Español">Español</option>
                            <option value="ar_TN" title="Arabic" data-content="<img src='http://../assets/images/flags/arab.svg' alt=''> العربية">العربية</option>
                            <option value="tr_TR" title="Turkish" data-content="<img src='http://../assets/images/flags/tr.svg' alt=''> Türkçe">Türkçe</option>
                        </select>
                    </li>
                    <li class="nav-item dropdown notification_dropdown">
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        <div class="dropdown">
                            <a class="nav-link primary show" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="true">
                                ...
                                <div class="dz-scroll p-2" style="height: 380px;">
                                    <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                        <div class="d-inline-block">
                                            <img src="http://../assets/images/avatar/small/avatar1.webp" alt="" class="rounded-circle avatar avatar-sm">
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                        <div class="d-inline-block">
                                            <img src="http://../assets/images/avatar/small/avatar2.webp" alt="" class="rounded-circle avatar avatar-sm">
                                        </div>
                                        <div class="clearfix ms-2">
                                            <h6 class="fs-13 mb-0 fw-semibold">Resport created successfully</h6>
                                            <small>29 July 2020 - 02:26 PM</small>
                                    ...
                                    <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                        <div class="d-inline-block">
                                            <img src="http://../assets/images/avatar/small/avatar3.webp" alt="" class="rounded-circle avatar avatar-sm">
                                        </div>
                                        <div class="clearfix ms-2">
                                            <h6 class="fs-13 mb-0 fw-semibold">Dr sultads Send you Photo</h6>
                                            <small>29 July 2020 - 02:26 PM</small>
                                    ...
                                    <div class="d-flex align-items-center p-2 bg-action-light rounded">
                                        <div class="d-inline-block">
                                            <img src="http://../assets/images/avatar/small/avatar4.webp" alt="" class="rounded-circle avatar avatar-sm">
                                        </div>
                                        <div class="clearfix ms-2">
                                            <h6 class="fs-13 mb-0 fw-semibold">Resport created successfully</h6>
                                            <small>29 July 2020 - 02:26 PM</small>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            <img src="http://../assets/images/profile/pic1.webp" width="20" alt="">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="http://../app-profile.html" class="dropdown-item ai-icon">
                                <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <span class="ms-2">Profile </span>
                            </a>
                            <a href="http://../email-inbox.html" class="dropdown-item ai-icon">
                                <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                <span class="ms-2">Inbox </span>
                            </a>
                            <a href="http://../page-login.html" class="dropdown-item ai-icon">
                    ...
                    <li class="dropdown schedule-event-inner primary">
                        <a href="javascript:void(0)" class="btn btn-primary rounded-5 event-btn">
        ...
        <ul class="metismenu" id="menu">
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="http://../index.html" data-i18n="Dashboard Light">Dashboard Light</a></li>
                    <li><a href="http://../index-dark.html" data-i18n="Dashboard Dark">Dashboard Dark</a></li>
                    <li><a href="http://../analytics.html" data-i18n="Analytics">Analytics</a></li>
                    <li><a href="http://../events.html" data-i18n="Events">Events</a></li>
                    <li><a href="http://../order-list.html" data-i18n="Order List">Order List</a></li>
                    <li><a href="http://../customer-list.html" data-i18n="Customer List">Customer List</a></li>
                    <li><a href="http://../reviews.html" data-i18n="Reviews">Reviews</a></li>
                </ul>
            </li>
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="http://../cms/content.html"  data-i18n="Content">Content</a></li>
                    <li><a href="http://../cms/content-add.html" data-i18n="Add Content">Add Content</a></li>
                    <li><a href="http://../cms/email-template.html" data-i18n="Email Template">Email Template</a></li>
                    <li><a href="http://../cms/add-email.html" data-i18n="Add Email">Add Email</a></li>
                    <li><a href="http://../cms/menu.html" data-i18n="Menus">Menus</a></li>
                    <li><a href="http://../cms/blog.html" data-i18n="Blog">Blog</a></li>
                    <li><a href="http://../cms/add-blog.html" data-i18n="Add Blog">Add Blog</a></li>
                    <li><a href="http://../cms/blog-category.html" data-i18n="Blog Category">Blog Category</a></li>
                </ul>
            </li>
            <li>
                <a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                    <i class="fa-regular fa-user fw-bold"></i>
                    <span class="nav-text" data-i18n="Profile">Profile <span class="badge badge-xs bg-danger ms-2">New</span></span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="http://../profile/overview.html" data-i18n="Overview">Overview</a></li>
                    <li><a href="http://../profile/projects.html" data-i18n="Projects">Projects</a></li>
                    <li><a href="http://../profile/projects-details.html" data-i18n="Projects Details">Projects Details</a></li>	
                    <li><a href="http://../profile/campaigns.html" data-i18n="Campaigns">Campaigns</a></li>		
                    <li><a href="http://../profile/documents.html" data-i18n="Documents">Documents</a></li>		
                    <li><a href="http://../profile/followers.html" data-i18n="Followers">Followers</a></li>	
                    <li><a href="http://../profile/activity.html" data-i18n="Activity">Activity</a></li>
                </ul>
            </li>
            <li>
                <a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                    <i class="fa-regular fa-user fw-bold"></i>
                    <span class="nav-text" data-i18n="Account">Account <span class="badge badge-xs bg-danger ms-2">New</span></span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="http://../account/overview.html" data-i18n="Overview">Overview</a></li>
                    <li><a href="http://../account/settings.html" data-i18n="Settings">Settings</a></li>
                    <li><a href="http://../account/security.html" data-i18n="Security">Security</a></li>	
                    <li><a href="http://../account/activity.html" data-i18n="Activity">Activity</a></li>		
                    <li><a href="http://../account/billing.html" data-i18n="Billing">Billing</a></li>		
                    <li><a href="http://../account/statements.html" data-i18n="Statements">Statements</a></li>	
                    <li><a href="http://../account/referrals.html" data-i18n="Referrals">Referrals</a></li>
                    <li><a href="http://../account/api-keys.html" data-i18n="Api Keys">Api Keys</a></li>
                    <li><a href="http://../account/logs.html" data-i18n="Logs">Logs</a></li>
                </ul>
            </li>
            <li>
                <a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                    <i class="flaticon-381-id-card"></i>
                    <span class="nav-text" data-i18n="Ticket">Ticket</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="http://../create-ticket.html" data-i18n="Create Ticket">Create Ticket</a></li>
                    <li><a href="http://../all-ticket.html" data-i18n="All Ticket">All Ticket</a></li>
                </ul>
            </li>
            <li>
                <a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="http://../customers-list.html" data-i18n="Customers List">Customers List</a></li>
                    <li><a href="http://../add-customers.html" data-i18n="Add Customers">Add Customers</a></li>
                    <li><a href="http://../chat.html" data-i18n="Chat">Chat</a></li>
                </ul>
            </li>
            <li>
                <a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="http://../app-profile.html" data-i18n="Profile">Profile</a></li>
                    <li><a href="http://../edit-profile.html" data-i18n="Edit Profile">Edit Profile</a></li>
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false" data-i18n="Email">Email</a>
                        <ul aria-expanded="false">
                            <li><a href="http://../email-compose.html" data-i18n="Compose">Compose</a></li>
                            <li><a href="http://../email-inbox.html" data-i18n="Inbox">Inbox</a></li>
                            <li><a href="http://../email-read.html" data-i18n="Read">Read</a></li>
                        </ul>
                    </li>
                    <li><a href="http://../app-calender.html" data-i18n="Calendar">Calendar</a></li>
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false" data-i18n="Shop">Shop</a>
                        <ul aria-expanded="false">
                            <li><a href="http://../ecom-product-grid.html" data-i18n="Product Grid">Product Grid</a></li>
                            <li><a href="http://../ecom-product-list.html" data-i18n="Product List">Product List</a></li>
                            <li><a href="http://../ecom-product-detail.html" data-i18n="Product Details">Product Details</a></li>
                            <li><a href="http://../ecom-product-order.html" data-i18n="Order">Order</a></li>
                            <li><a href="http://../ecom-checkout.html" data-i18n="Checkout">Checkout</a></li>
                            <li><a href="http://../ecom-invoice.html" data-i18n="Invoice">Invoice</a></li>
                            <li><a href="http://../ecom-customers.html" data-i18n="Customers">Customers</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                    ...
                    <span class="nav-text" data-i18n="AIKit">AIKit <span class="badge badge-xs bg-danger ms-2">New</span></span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="http://../aikit/auto-write.html" data-i18n="Auto Writer">Auto Writer</a></li>
                    <li><a href="http://../aikit/scheduled.html" data-i18n="Scheduler">Scheduler</a></li>
                    <li><a href="http://../aikit/repurpose.html" data-i18n="Repurpose">Repurpose</a></li>
                    <li><a href="http://../aikit/rss.html" data-i18n="RSS">RSS</a></li>
                    <li><a href="http://../aikit/chatbot.html" data-i18n="Chatbot">Chatbot</a></li>
                    <li><a href="http://../aikit/fine-tune-models.html" data-i18n="Fine Tune Models">Fine Tune Models</a></li>
                    <li><a href="http://../aikit/prompt.html" data-i18n="AI Menu Prompts">AI Menu Prompts</a></li>
                    <li><a href="http://../aikit/setting.html" data-i18n="Settings">Settings</a></li>
                    <li><a href="http://../aikit/import.html" data-i18n="Export/Import Settings">Export/Import Settings</a></li>
                </ul>
            </li>
            <li><a href="http://../reports.html" class="ai-icon" aria-expanded="false">
                    <i class="flaticon-381-list"></i>
                    <span class="nav-text" data-i18n="Report">Report</span>
                </a>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="http://../pages/page-register.html" data-i18n="Register">Register</a></li>
                    <li><a href="http://../pages/page-login.html" data-i18n="Login">Login</a></li>
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false" data-i18n="Error">Error</a>
                        <ul aria-expanded="false">
                            <li><a href="http://../pages/page-error-400.html" data-i18n="Error 400">Error 400</a></li>
                            <li><a href="http://../pages/page-error-403.html" data-i18n="Error 403">Error 403</a></li>
                            <li><a href="http://../pages/page-error-404.html" data-i18n="Error 404">Error 404</a></li>
                            <li><a href="http://../pages/page-error-500.html" data-i18n="Error 500">Error 500</a></li>
                            <li><a href="http://../pages/page-error-503.html" data-i18n="Error 503">Error 503</a></li>
                        </ul>
                    </li>
                    <li><a href="http://../pages/page-lock-screen.html" data-i18n="Lock Screen">Lock Screen</a></li>
                </ul>
            </li>
        </ul>
    </div>
					...
					<div class="card-body d-flex py-md-4">
						<div class="clearfix">
							<div class="d-inline-block position-relative me-sm-4 me-3 mb-3 mb-lg-0">
								<img src="http://../assets/images/avatar/large/avatar5.webp" class="avatar avatar-xxl" alt="">
						...
						<div class="clearfix d-xl-flex flex-grow-1">
							<div class="clearfix pe-md-5">
								<h3 class="fw-semibold mb-1">Amelia Rose<img src="http://../assets/images/blue-tick.avif" alt="Blue Tick"></h3>
								<ul class="d-flex flex-wrap align-items-center">
									...
									<li class="me-3 d-inline-flex align-items-center"><i class="las la-envelope me-1"></i>info@gmail.com</li>
								</ul>
					...
					<div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center mx-sm-4 px-0">
						<ul class="nav nav-underline gap-3 nav-scroll nav-scroll-auto-xl px-3 px-sm-0" id="tabMyProfileBottom" role="tablist">
							<li class="nav-item" role="presentation">
								<a href="http://../profile/overview.html" class="nav-link py-3 px-1 border-3 active">Overview</a>
							</li>
							<li class="nav-item" role="presentation">
								<a href="http://../profile/projects.html" class="nav-link py-3 px-1 border-3">Projects</a>
							</li>
							<li class="nav-item" role="presentation">
								<a href="http://../profile/campaigns.html" class="nav-link py-3 px-1 border-3">Campaigns</a>
							</li>
							<li class="nav-item" role="presentation">
								<a href="http://../profile/documents.html" class="nav-link py-3 px-1 border-3">Documents</a>
							</li>
							<li class="nav-item" role="presentation">
								<a href="http://../profile/followers.html" class="nav-link py-3 px-1 border-3">Followers</a>
							</li>
							<li class="nav-item" role="presentation">
								<a href="http://../profile/activity.html" class="nav-link py-3 px-1 border-3">Activity</a>
							</li>
						</ul>
										...
										<div class="card-body pb-2">
											<div class="d-flex justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<div class="d-inline-block">
														<img src="http://../assets/images/avatar/small/avatar1.webp" class="avatar avatar-sm me-2" alt="">
													</div>
													<div class="clearfix ms-2">
														<h6 class="mb-0 fw-semibold">Amelia Rose</h6>
														<span class="d-block small">Yestarday at 4:30 PM</span>
													</div>
												</div>
												<div class="clearfix ms-auto">
													<button type="button" class="btn btn-square btn-light btn-sm"><i class="bi bi-grid"></i></button>
												</div>
											</div>
											<div class="clearfix">
											...
											<div class="position-relative border-top mt-3">
												<input type="text" class="form-control border-0 pe-5 shadow-none px-0" placeholder="Reply..">
												<div class="d-flex position-absolute end-0 top-50 translate-middle-y">
													<a href="javascript:void(0);" class="btn btn-square btn-sm btn-link">
														<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#888888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
									...
									<div class="card">
										<div class="card-body pb-2">
											<div class="d-flex justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<div class="d-inline-block">
														<img src="http://../assets/images/avatar/small/avatar2.webp" class="avatar avatar-sm me-2" alt="">
													</div>
													<div class="clearfix ms-2">
														<h6 class="mb-0 fw-semibold">Elijah James</h6>
														<span class="d-block small">Yestarday at 5:30 PM</span>
													</div>
												</div>
												<div class="clearfix ms-auto">
													<button type="button" class="btn btn-square btn-light btn-sm"><i class="bi bi-grid"></i></button>
											...
											<div class="gallery-grid rows-3" id="lightgallery">
												<a href="http://../assets/images/post/img-full1.webp" data-exthumbimage="assets/images/post/img-full1.webp" data-src="assets/images/post/img-full1.webp" class="grid-item colspan-3 rowspan-2">
													<img src="http://../assets/images/post/img-full1.webp" alt="">
												</a>
												<a href="http://../assets/images/post/img2.webp" data-exthumbimage="assets/images/post/img2.webp" data-src="assets/images/post/img2.webp" class="grid-item">
													<img src="http://../assets/images/post/img2.webp" alt="">
												</a>
												<a href="http://../assets/images/post/img1.webp" data-exthumbimage="assets/images/post/img1.webp" data-src="assets/images/post/img1.webp" class="grid-item">
													<img src="http://../assets/images/post/img1.webp" alt="">
												</a>
												<a href="http://../assets/images/post/img3.webp" data-exthumbimage="assets/images/post/img3.webp" data-src="assets/images/post/img3.webp" class="grid-item gallery-more" data-more="+06">
													<img src="http://../assets/images/post/img3.webp" alt="">
												</a>
											</div>
											<div class="clearfix">
												<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
									...
									<div class="card">
										<div class="card-body pb-2">
											<div class="d-flex justify-content-between mb-3">
												<div class="d-flex align-items-center py-2">
													<div class="d-inline-block position-relative">
														<img src="http://../assets/images/avatar/small/avatar3.webp" class="avatar avatar-sm me-2" alt="">
													</div>
													<div class="clearfix ms-2">
														<h6 class="fs-14 mb-0 fw-semibold">Charlotte Mae</h6>
											...
											<div class="gallery-grid rows-3" id="lightgallery2">
												<a href="http://../assets/images/post/img-full2.webp" data-exthumbimage="assets/images/post/img-full2.webp" data-src="assets/images/post/img-full2.webp" class="grid-item colspan-2 rowspan-3">
													<img src="http://../assets/images/post/img-full2.webp" alt="">
												</a>
												<a href="http://../assets/images/post/img4.webp" data-exthumbimage="assets/images/post/img4.webp" data-src="assets/images/post/img4.webp" class="grid-item">
													<img src="http://../assets/images/post/img4.webp" alt="">
												</a>
												<a href="http://../assets/images/post/img5.webp" data-exthumbimage="assets/images/post/img5.webp" data-src="assets/images/post/img5.webp" class="grid-item">
													<img src="http://../assets/images/post/img5.webp" alt="">
												</a>
												<a href="http://../assets/images/post/img6.webp" data-exthumbimage="assets/images/post/img6.webp" data-src="assets/images/post/img6.webp" class="grid-item gallery-more" data-more="+3">
													<img src="http://../assets/images/post/img6.webp" alt="">
												</a>
											</div>
											<div class="clearfix">
												<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
									...
									<div class="card">
										<div class="card-body pb-2">
											<div class="d-flex justify-content-between mb-2">
												<div class="d-flex justify-content-between mb-3">
													<div class="d-inline-block position-relative">
														<img src="http://../assets/images/avatar/small/avatar4.webp" class="avatar avatar-sm me-2" alt="">
													</div>
													<div class="clearfix ms-2">
														<h6 class="fs-14 mb-0 fw-semibold">Liam Risher</h6>
														<span class="fs-13">Yestarday at 5:30 PM</span>
													</div>
												</div>
												<div class="clearfix ms-auto">
									...
									<div class="card">
										<div class="card-body pb-2">
											<div class="d-flex justify-content-between mb-3">
												<div class="d-flex align-items-center py-2">
													<div class="d-inline-block position-relative">
														<img src="http://../assets/images/avatar/small/avatar5.webp" class="avatar avatar-sm me-2" alt="">
													</div>
													<div class="clearfix ms-2">
														<h6 class="fs-14 mb-0 fw-semibold">Isabella Claire</h6>
														<span class="fs-13">Yestarday at 5:30 PM</span>
													</div>
												</div>
												<div class="clearfix ms-auto">
											...
											<div class="post-quote post-quote-img p-4 text-center mb-2 rounded" style="background-image: url('http://../assets/images/post/img8.webp');">
									...
									<div class="card">
										<div class="card-body pb-2">
											<div class="d-flex justify-content-between mb-3">
												<div class="d-flex align-items-center py-2">
													<div class="d-inline-block position-relative">
														<img src="http://../assets/images/avatar/small/avatar6.webp" class="avatar avatar-sm me-2" alt="">
													</div>
													<div class="clearfix ms-2">
														<h6 class="fs-14 mb-0 fw-semibold">Ethan Cole</h6>
														<span class="fs-13">Yestarday at 5:30 PM</span>
													</div>
												</div>
												<div class="clearfix ms-auto">
											...
											<div class="clearfix mb-2">
												<img src="http://../assets/images/post/img7.webp" alt="" class="rounded w-100">
											</div>
											<div class="clearfix">
												<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
											</div>
									...
									<div class="card">
										<div class="card-body pb-2">
											<div class="d-flex justify-content-between mb-3">
												<div class="d-flex align-items-center py-2">
													<div class="d-inline-block position-relative">
														<img src="http://../assets/images/avatar/small/avatar7.webp" class="avatar avatar-sm me-2" alt="">
													</div>
													<div class="clearfix ms-2">
														<h6 class="fs-14 mb-0 fw-semibold">Sophia Jane</h6>
														<span class="fs-13">Yestarday at 5:30 PM</span>
													</div>
												</div>
												<div class="clearfix ms-auto">
											...
											<div class="clearfix mb-2">
												<iframe class="rounded soundcloud-iframe" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/539018871&amp;color=%23ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;show_teaser=true"></iframe>
											</div>
											<div class="clearfix">
												<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
											</div>
									...
									<div class="card">
										<div class="card-body pb-2">
											<div class="d-flex justify-content-between mb-3">
												<div class="d-flex align-items-center py-2">
													<div class="d-inline-block position-relative">
														<img src="http://../assets/images/avatar/small/avatar8.webp" class="avatar avatar-sm me-2" alt="">
													</div>
													<div class="clearfix ms-2">
														<h6 class="fs-14 mb-0 fw-semibold">Henry Mason</h6>
														<span class="fs-13">Yestarday at 5:30 PM</span>
													</div>
												</div>
												<div class="clearfix ms-auto">
											...
											<div class="clearfix mb-2 text-center">
												<img src="http://../assets/images/post/img6.webp" alt="" class="rounded">
											</div>
											<div class="clearfix">
												<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
											</div>
									...
									<div class="card">
										<div class="card-body pb-2">
											<div class="d-flex justify-content-between mb-3">
												<div class="d-flex align-items-center py-2">
													<div class="d-inline-block position-relative">
														<img src="http://../assets/images/avatar/small/avatar9.webp" class="avatar avatar-sm me-2" alt="">
													</div>
													<div class="clearfix ms-2">
														<h6 class="fs-14 mb-0 fw-semibold">Evelyn Hope</h6>
														<span class="fs-13">Yestarday at 5:30 PM</span>
													</div>
												</div>
												<div class="clearfix ms-auto">
											...
											<div class="clearfix mb-2">
												<iframe class="rounded video-iframe" src="https://www.youtube.com/embed/pyRjzvdOSHk" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
											</div>
											<div class="clearfix">
												<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
											</div>
										...
										<div class="card-body pb-2">
											<div class="clearfix mb-3">
												<div class="d-flex justify-content-between mb-3">
													<div class="d-flex align-items-center py-2">
														<div class="d-inline-block position-relative">
															<img src="http://../assets/images/avatar/small/avatar10.webp" class="avatar avatar-sm me-2" alt="">
														</div>
														<div class="clearfix ms-2">
															<h6 class="fs-14 mb-0 fw-semibold">Lucas Bennett</h6>
											...
											<div class="d-flex py-2 position-relative">
												...
												<div class="clearfix ms-2">
													<h6 class="fs-13 mb-1 fw-semibold">Isabella Claire<span class="fs-12 text-muted ms-1 fw-normal">2 Day ago</span></h6>
													<p class="small mb-0">There are many variations of passages of Lorem Ipsum available.</p>
												</div>
											...
											<div class="d-flex py-2 position-relative">
												...
												<div class="clearfix ms-2">
													<h6 class="fs-13 mb-1 fw-semibold">Liam Risher<span class="fs-12 text-muted ms-1 fw-normal">3 Days ago</span></h6>
													<p class="small mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
												</div>
												<a href="javascript:void(0);" class="position-absolute end-0 top-0">Reply</a>
											</div>
											<div class="position-relative border-top mt-3">
										...
										<div class="card-body pb-2">
											<div class="d-flex justify-content-between mb-2">
												<div class="d-flex align-items-center py-2">
													...
													<div class="clearfix ms-2">
														<h6 class="fs-14 mb-0 fw-semibold">Amelia Rose</h6>
							...
							<div class="row sticky-top z-0">
								...
								<div class="col-xxl-6 col-xl-12 col-md-6">
									<div class="card">
										...
										<div class="card-body">
											<div class="d-flex align-items-center p-2 bg-action-light rounded my-1">
												<div class="avatar avatar-sm bg-white p-2">
													<img src="http://../assets/images/logo/google.avif" alt="">
												</div>
												<div class="clearfix ms-3">
													<h6 class="mb-0 fw-semibold">Piper Aerostar</h6>
													<span class="small d-block">piper-aircraft-class.jsp</span>
												</div>
												<div class="clearfix ms-auto">
													<span class="badge badge-sm bg-primary">0</span>
												</div>
											</div>
											<div class="d-flex align-items-center p-2 bg-action-light rounded my-1">
												<div class="avatar avatar-sm bg-white p-2">
													<img src="http://../assets/images/logo/figma.avif" alt="">
												</div>
												<div class="clearfix ms-3">
													<h6 class="mb-0 fw-semibold">Cirrus SR22</h6>
													<span class="small d-block">cirrus-aircraft.jsp</span>
												</div>
												<div class="clearfix ms-auto">
													<span class="badge badge-sm bg-primary">3</span>
												</div>
											</div>
											<div class="d-flex align-items-center p-2 bg-action-light rounded my-1">
												<div class="avatar avatar-sm bg-white p-2">
													<img src="http://../assets/images/logo/slack.avif" alt="">
												</div>
												<div class="clearfix ms-3">
													<h6 class="mb-0 fw-semibold">Beachcraft Baron</h6>
													<span class="small d-block">baron-class.pyt</span>
												</div>
												<div class="clearfix ms-auto">
													<span class="badge badge-sm bg-primary">0</span>
												</div>
											...
											<div class="d-flex align-items-center p-2 bg-action-light rounded my-1">
												<div class="avatar avatar-sm bg-white p-2">
													<img src="http://../assets/images/logo/html.avif" alt="">
												</div>
												<div class="clearfix ms-3">
													<h6 class="mb-0 fw-semibold">Cessna SF150</h6>
													<span class="small d-block">cessna-aircraft-class.jsp</span>
												</div>
												<div class="clearfix ms-auto">
													<span class="badge badge-sm bg-primary">0</span>
												</div>
										...
										<div class="card-footer border-0 pt-0">
											<div class="alert alert-primary outline-dashed border-2 py-3 px-3 mb-0 text-dark">
												<strong class="text-primary">Welcome fresh .NET experts</strong> to develop top-tier modular JSP class scripts for seamless B2B solutions!
											</div>
										</div>
									</div>
								</div>
								<!-- End - Projects Contributions -->
									...
									<div class="card">
										...
										<div class="card-body dz-scroll height380">
											<div class="widget-timeline1">
												<ul class="timeline">
													<li>
														<span class="timeline-status">07:45</span>
														<div class="timeline-badge border-dark"></div>
														<div class="timeline-panel">
															<span>Started the day with a fresh perspective—embracing challenges like a pro.</span>
														</div>
													</li>
													<li>
														<span class="timeline-status">11:25</span>
														<div class="timeline-badge border-success"></div>
														<div class="timeline-panel">
															<span><span class="text-secondary fs-14 fw-semibold">Video uploaded</span> and shared with the world.</span>
														</div>
													</li>
													<li>
														<span class="timeline-status">09:28</span>
														<div class="timeline-badge border-danger"></div>
														<div class="timeline-panel">
															<span class="text-secondary fs-14 fw-semibold">John made a smart move—grabbed a deal worth <span class="text-primary">$350</span></span>
														</div>
													</li>
													<li>
													...
													<li>
														...
														<div class="timeline-panel">
															<span><span class="text-secondary fs-14 fw-semibold">Breaking news:</span> Mashable emerges as a go-to hub for all things trending.</span>
														</div>
													</li>
													<li>
														<span class="timeline-status">02:40</span>
														<div class="timeline-badge border-primary"></div>
														<div class="timeline-panel">
															<span>Revisited an old memory—shared this on my FB wall a while ago.</span>
														</div>
													</li>
													<li>
														...
														<div class="timeline-badge border-success"></div>
														<div class="timeline-panel">
															<span>Another video making rounds—content is king!</span>
														</div>
													</li>
												</ul>
											</div>
								...
								<div class="col-xxl-12 col-xl-12 col-md-12">
									<div class="card">
										...
										<div class="card-body pt-1">
											<div class="row align-items-center">
												...
												<div class="col-sm-6 mb-2">
													...
													<div class="d-flex justify-content-between mb-3">
														<div class="text-black">
															<i class="fa-solid fa-square text-secondary me-1"></i> Earbuds
														</div>
														<span>25</span>
													</div>
												</div>
										...
										<div class="card-footer border-0 pt-0">
											<div class="alert alert-outline-primary outline-dashed p-3 d-sm-flex align-items-center justify-content-between mb-0">
												<p class="mb-0">Comprehensive Category Analysis & Revenue Trends for This Quarter!</p>
								...
								<div class="col-xxl-7 col-xl-12 col-md-6">
									<div class="card">
										...
										<div class="card-body p-0">
											<div class="list-group list-group-flush dz-draggable dropzoneContainer dz-scroll height380">
														...
														<div class="d-flex gap-3">
															...
															<div class="clearfix">
																<div class="form-check">
																	...
																	<label class="form-check-label text-black" for="customCheckBox1">Compete this projects Monday</label>
																</div>
								...
								<!-- Start - Projects Status -->
								<div class="col-xxl-5 col-xl-12 col-md-6">
									<div class="card">
										<div class="card-header pb-0 border-0 align-items-center">
											<div>
										...
										<div class="card-body">
											<div id="projectChart" class="d-flex justify-content-center"></div>
											<div class="clearfix mt-4">
												...
												<div class="d-flex justify-content-between mb-3">
													<div class="text-black">
														<i class="fa-solid fa-square text-danger me-1"></i> Cancelled Projects
													</div>
													<span>10</span>
												</div>
												<div class="d-flex justify-content-between mb-3">
