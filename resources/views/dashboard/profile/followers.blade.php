...
<!-- Mirrored from tixia-html.vercel.app/profile/followers.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:12 GMT -->
				...
				<div class="card h-auto px-md-2 pt-md-2">
					...
					<div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center mx-sm-4 px-0">
						<ul class="nav nav-underline gap-3 nav-scroll nav-scroll-auto-xl px-3 px-sm-0" id="tabMyProfileBottom" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<a href="http://../profile/followers.html" class="nav-link py-3 px-1 border-3 active">Followers</a>
							</li>
							<li class="nav-item" role="presentation">
					...
					<div class="row">
							...
							<div class="card">
								<div class="card-body text-center p-md-4">
									<div class="mx-auto d-inline-block position-relative mb-3">
										<img src="http://../assets/images/avatar/small/avatar1.webp" alt="" class="rounded-circle avatar">
										<span class="fa fa-circle bored border-light text-success position-absolute bottom-0 end-0 mb-0 me-1 fs-12"></span>
									</div>
									<div class="mb-4">
										<h4 class="mb-0"><a href="javascript:void(0);">Lawrence</a></h4>
										<p class="mb-0">Art Director at DexignZone.</p>
									</div>
									<div class="d-flex justify-content-center px-3">
										<div class="bg-light rounded px-3 py-2 text-start mx-2 flex-grow-1">
											<h6 class="mb-0">$12,500.00</h6>
											<span class="small">Avg. Deal</span>
										</div>
										<div class="bg-light rounded px-3 py-2 text-start mx-2 flex-grow-1">
											<h6 class="mb-0">$150,500.00</h6>
											<span class="small">Deals</span>
										</div>
									</div>
									<button type="button" class="btn btn-sm btn-light btn-active mt-4">
										<span class="active-before"><i class="la la-user me-1"></i> Follow</span>
										<span class="active-after"><i class="la la-check me-1"></i> Following</span>
									</button>
								</div>
							</div>
						</div>
						...
						<div class="col-xxl-3 col-xl-4 col-sm-6">
							<div class="card">
								<div class="card-body text-center p-md-4">
									<div class="mx-auto d-inline-block position-relative mb-3">
										<div class="avatar avatar-info rounded-circle">S</div>
										<span class="fa fa-circle bored border-light text-success position-absolute bottom-0 end-0 mb-0 me-1 fs-12"></span>
									</div>
									<div class="mb-4">
										<h4 class="mb-0"><a href="javascript:void(0);">Sophia Jane</a></h4>
										<p class="mb-0">Art Director at DexignZone.</p>
									</div>
									<div class="d-flex justify-content-center px-3">
										<div class="bg-light rounded px-3 py-2 text-start mx-2 flex-grow-1">
						...
						<div class="col-xxl-3 col-xl-4 col-sm-6">
							<div class="card">
								<div class="card-body text-center p-md-4">
									<div class="mx-auto d-inline-block position-relative mb-3">
										<img src="http://../assets/images/avatar/small/avatar2.webp" alt="" class="rounded-circle avatar">
										<span class="fa fa-circle bored border-light text-success position-absolute bottom-0 end-0 mb-0 me-1 fs-12"></span>
									</div>
									<div class="mb-4">
										<h4 class="mb-0"><a href="javascript:void(0);">Evelyn Hope</a></h4>
										<p class="mb-0">Art Director at DexignZone.</p>
									</div>
									<div class="d-flex justify-content-center px-3">
										<div class="bg-light rounded px-3 py-2 text-start mx-2 flex-grow-1">
						...
						<div class="col-xxl-3 col-xl-4 col-sm-6">
							<div class="card">
								<div class="card-body text-center p-md-4">
									<div class="mx-auto d-inline-block position-relative mb-3">
										<div class="avatar-primary avatar rounded-circle">E</div>
										<span class="fa fa-circle bored border-light text-success position-absolute bottom-0 end-0 mb-0 me-1 fs-12"></span>
									</div>
									<div class="mb-4">
										<h4 class="mb-0"><a href="javascript:void(0);">Ethan Cole</a></h4>
										<p class="mb-0">Art Director at DexignZone.</p>
									</div>
									<div class="d-flex justify-content-center px-3">
										<div class="bg-light rounded px-3 py-2 text-start mx-2 flex-grow-1">
						...
						<div class="col-xxl-3 col-xl-4 col-sm-6">
							<div class="card">
								<div class="card-body text-center p-md-4">
									<div class="mx-auto d-inline-block position-relative mb-3">
										<img src="http://../assets/images/avatar/small/avatar3.webp" alt="" class="rounded-circle avatar">
										<span class="fa fa-circle bored border-light text-success position-absolute bottom-0 end-0 mb-0 me-1 fs-12"></span>
									</div>
									<div class="mb-4">
										<h4 class="mb-0"><a href="javascript:void(0);">Abigail Faith</a></h4>
										<p class="mb-0">Web Designer at DexignZone.</p>
									</div>
									<div class="d-flex justify-content-center px-3">
										<div class="bg-light rounded px-3 py-2 text-start mx-2 flex-grow-1">
											<h6 class="mb-0">$12,500.00</h6>
						...
						<div class="col-xxl-3 col-xl-4 col-sm-6">
							<div class="card">
								<div class="card-body text-center p-md-4">
									<div class="mx-auto d-inline-block position-relative mb-3">
										<img src="http://../assets/images/avatar/small/avatar4.webp" alt="" class="rounded-circle avatar">
										<span class="fa fa-circle bored border-light text-success position-absolute bottom-0 end-0 mb-0 me-1 fs-12"></span>
									</div>
									<div class="mb-4">
										<h4 class="mb-0"><a href="javascript:void(0);">Jackson Miles</a></h4>
										<p class="mb-0">PHP Developer at DexignZone.</p>
									</div>
									<div class="d-flex justify-content-center px-3">
										<div class="bg-light rounded px-3 py-2 text-start mx-2 flex-grow-1">
											<h6 class="mb-0">$12,500.00</h6>
						...
						<div class="col-xxl-3 col-xl-4 col-sm-6">
							<div class="card">
								<div class="card-body text-center p-md-4">
									<div class="mx-auto d-inline-block position-relative mb-3">
										<div class="avatar-warning avatar rounded-circle">A</div>
										<span class="fa fa-circle bored border-light text-success position-absolute bottom-0 end-0 mb-0 me-1 fs-12"></span>
									</div>
									<div class="mb-4">
										<h4 class="mb-0"><a href="javascript:void(0);">Alexander Finn</a></h4>
										<p class="mb-0">React Developer at DexignZone.</p>
									</div>
									<div class="d-flex justify-content-center px-3">
										<div class="bg-light rounded px-3 py-2 text-start mx-2 flex-grow-1">
											<h6 class="mb-0">$12,500.00</h6>
						...
						<div class="col-xxl-3 col-xl-4 col-sm-6">
							<div class="card">
								<div class="card-body text-center p-md-4">
									<div class="mx-auto d-inline-block position-relative mb-3">
										<div class="avatar-success avatar rounded-circle">C</div>
									</div>
									<div class="mb-4">
										<h4 class="mb-0"><a href="javascript:void(0);">Charlotte Mae</a></h4>
										<p class="mb-0">React Native Developer at DexignZone.</p>
									</div>
									<div class="d-flex justify-content-center px-3">
										<div class="bg-light rounded px-3 py-2 text-start mx-2 flex-grow-1">
											<h6 class="mb-0">$12,500.00</h6>
