...
<!-- Mirrored from tixia-html.vercel.app/profile/documents.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:12 GMT -->
				...
				<div class="card h-auto px-md-2 pt-md-2">
					...
					<div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center mx-sm-4 px-0">
						<ul class="nav nav-underline gap-3 nav-scroll nav-scroll-auto-xl px-3 px-sm-0" id="tabMyProfileBottom" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<a href="http://../profile/documents.html" class="nav-link py-3 px-1 border-3 active">Documents</a>
							</li>
							<li class="nav-item" role="presentation">
							...
							<div class="row">	
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="http://../assets/images/files/folder.avif" width="45" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">Billing Statement</h6>
												<span class="fs-14">10 files</span>
											</div>
										</div>
									</div>
								</div>
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											...
											<div class="clearfix">
												<h6 class="mb-0">Skyline Records</h6>
												<span class="fs-14">15 files</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="http://../assets/images/files/folder.avif" width="35" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">Avionica</h6>
								...
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="http://../assets/images/files/html.avif" width="35" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="http://../assets/images/files/ppt.avif" width="35" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="http://../assets/images/files/mp3.avif" width="35" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">Design Logo</h6>
							...
							<div class="row">
									...
									<div class="card">
										<div class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="http://../assets/images/files/folder.avif" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xxl-2 col-xl-3 col-lg-4 col-sm-6">
									<div class="card">
										<div class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="http://../assets/images/files/csv.avif" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xxl-2 col-xl-3 col-lg-4 col-sm-6">
									<div class="card">
										<div class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="http://../assets/images/files/css.avif" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xxl-2 col-xl-3 col-lg-4 col-sm-6">
									<div class="card">
										<div class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="http://../assets/images/files/pdf.avif" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xxl-2 col-xl-3 col-lg-4 col-sm-6">
									<div class="card">
										<div class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="http://../assets/images/files/html.avif" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xxl-2 col-xl-3 col-lg-4 col-sm-6">
									<div class="card">
										<div class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="http://../assets/images/files/ppt.avif" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xxl-2 col-xl-3 col-lg-4 col-sm-6">
									<div class="card">
										<div class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="http://../assets/images/files/mp3.avif" alt="">
											</div>
											<div class="clearfix">
