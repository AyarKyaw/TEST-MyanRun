...
<!-- Mirrored from tixia-html.vercel.app/profile/campaigns.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:11 GMT -->
				...
				<div class="card h-auto px-md-2 pt-md-2">
					...
					<div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center mx-sm-4 px-0">
						<ul class="nav nav-underline gap-3 nav-scroll nav-scroll-auto-xl px-3 px-sm-0" id="tabMyProfileBottom" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<a href="http://../profile/campaigns.html" class="nav-link py-3 px-1 border-3 active">Campaigns</a>
							</li>
							<li class="nav-item" role="presentation">
									...
									<div class="d-flex justify-content-between mb-4 align-items-center gap-2">
										<div class="d-flex align-items-center">
											<div class="avatar avatar-sm p-2">
												<img src="http://../assets/images/logo/large/twitch.avif" width="35" alt="">
											</div>
											<span class="ms-3">Twitch Ads</span>
										</div>
										<button type="button" class="btn btn-square btn-primary light btn-sm"><i class="bi bi-grid"></i></button>
									</div>
							...
							<div class="card overflow-hidden">
								<div class="card-body p-xxl-4">
									<div class="d-flex justify-content-between mb-4 align-items-center gap-2">
										<div class="d-flex align-items-center">
											<div class="avatar avatar-sm p-2">
												<img src="http://../assets/images/logo/large/twitter.avif" width="35" alt="">
											</div>
											<span class="ms-3">Twitch Ads</span>
										</div>
										<button type="button" class="btn btn-square btn-primary light btn-sm"><i class="bi bi-grid"></i></button>
							...
							<div class="card overflow-hidden">
								<div class="card-body p-xxl-4">
									<div class="d-flex justify-content-between mb-4 align-items-center gap-2">
										<div class="d-flex align-items-center">
											<div class="avatar avatar-sm p-2">
												<img src="http://../assets/images/logo/large/spotify.avif" width="35" alt="">
											</div>
							...
							<div class="card overflow-hidden">
								<div class="card-body p-xxl-4">
									<div class="d-flex justify-content-between mb-4 align-items-center gap-2">
										<div class="d-flex align-items-center">
											<div class="avatar avatar-sm p-2">
												<img src="http://../assets/images/logo/large/telegram.avif" width="35" alt="">
											</div>
							...
							<div class="card overflow-hidden">
								<div class="card-body p-xxl-4">
									<div class="d-flex justify-content-between mb-4 align-items-center gap-2">
										<div class="d-flex align-items-center">
											<div class="avatar avatar-sm p-2">
												<img src="http://../assets/images/logo/large/pinterest.avif" width="35" alt="">
											</div>
							...
							<div class="card overflow-hidden">
								<div class="card-body p-xxl-4">
									<div class="d-flex justify-content-between mb-4 align-items-center gap-2">
										<div class="d-flex align-items-center">
											<div class="avatar avatar-sm p-2">
												<img src="http://../assets/images/logo/large/github.avif" width="35" alt="">
											</div>
							...
							<div class="card overflow-hidden">
								<div class="card-body p-xxl-4">
									<div class="d-flex justify-content-between mb-4 align-items-center gap-2">
										<div class="d-flex align-items-center">
											<div class="avatar avatar-sm p-2">
												<img src="http://../assets/images/logo/large/youtube.avif" width="35" alt="">
											</div>
							...
							<div class="card overflow-hidden">
								<div class="card-body p-xxl-4">
									<div class="d-flex justify-content-between mb-4 align-items-center gap-2">
										<div class="d-flex align-items-center">
											<div class="avatar avatar-sm p-2">
												<img src="http://../assets/images/logo/large/reddit.avif" width="35" alt="">
											</div>
