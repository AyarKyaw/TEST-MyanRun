...
<!-- Mirrored from tixia-html.vercel.app/ecom-product-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:22 GMT -->
                            ...
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="text-center mt-3">
                                        <h5 class="mb-1">Bonorum et Malorum</h5>
										...
										<del class="fs-14 me-2 text-danger">$761.00</del>
                                        <span class="fs-16 text-primary fw-semibold">$156.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="text-center mt-3">
                                        <h5 class="mb-1">Striped Dress</h5>
                                        <ul class="d-flex justify-content-center gap-1">
                                            <li><i class="fa fa-star text-warning"></i></li>
                                            <li><i class="fa fa-star text-warning"></i></li>
                                            <li><i class="fa fa-star text-warning"></i></li>
										...
										<del class="fs-14 me-2 text-danger">$861.00</del>
                                        <span class="fs-16 text-primary fw-semibold">$259.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="text-center mt-3">
                                        <h4 class="mb-1">BBow polka-dot</h4>
                                        <ul class="d-flex justify-content-center gap-1">
                                            <li><i class="fa fa-star text-warning"></i></li>
                                            <li><i class="fa fa-star text-warning"></i></li>
                                            <li><i class="fa fa-star text-warning"></i></li>
										...
										<del class="fs-14 me-2 text-danger">$261.00</del>
                                        <span class="fs-16 text-primary fw-semibold">$57.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="text-center mt-3">
                                        <h4 class="mb-1">Z Product 360</h4>
                                        <ul class="d-flex justify-content-center gap-1">
                                            <li><i class="fa fa-star text-warning"></i></li>
                                            <li><i class="fa fa-star text-warning"></i></li>
                                            <li><i class="fa fa-star text-warning"></i></li>
										...
										<del class="fs-14 me-2 text-danger">$561.00</del>
                                        <span class="fs-16 text-primary fw-semibold">$254.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="text-center mt-3">
										...
										<del class="fs-14 me-2 text-danger">$850.00</del>
                                        <span class="fs-16 text-primary fw-semibold">$369.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="text-center mt-3">
                                        <h4 class="mb-1">fox sake withe</h4>
                                        <ul class="d-flex justify-content-center gap-1">
                                            <li><i class="fa fa-star text-warning"></i></li>
                                            <li><i class="fa fa-star text-warning"></i></li>
                                            <li><i class="fa fa-star text-warning"></i></li>
										...
										<del class="fs-14 me-2 text-danger">$961.00</del>
                                        <span class="fs-16 text-primary fw-semibold">$245.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    <div class="overflow-hidden rounded">
                                        <img class="img-fluid" src="assets/images/product/7.webp" alt="/">
                                    </div>
                                    <div class="text-center mt-3">
                                        <h4 class="mb-1">Back Bag</h4>
                                        <ul class="d-flex justify-content-center gap-1">
                                            <li><i class="fa fa-star text-warning"></i></li>
                                            <li><i class="fa fa-star text-warning"></i></li>
                                            <li><i class="fa fa-star text-warning"></i></li>
										...
										<del class="fs-14 me-2 text-danger">$465.00</del>
                                        <span class="fs-16 text-primary fw-semibold">$164.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="text-center mt-3">
										...
										<del class="fs-14 me-2 text-danger">$261.00</del>
                                        <span class="fs-16 text-primary fw-semibold">$48.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from tixia-html.vercel.app/ecom-product-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:27 GMT -->
</html>