...
<!-- Mirrored from tixia-html.vercel.app/all-ticket.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:15 GMT -->
...
<!-- End - Sidebar -->
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">All Ticket</li>
    </ol>
</nav>
				</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								  ...
								  <a href="create-ticket.html" class="btn btn-primary">Add ticket</a>
							 </div>
							 <div class="card-body">
									...
									<table id="example" class="display dataTablesCard table-responsive-xl" style="min-width: 845px">
										<thead>
											<tr>
												...
												<th class="mw-90">Priority</th>
												<th class="mw-110">Category</th>
												<th class="mw-100">Date</th>
												<th class="mw-110">Status</th>
												<th class="mw-100">Assign To</th>
												<th class="mw-120">Last Reply</th>
												<th class="mw-90">Actions</th>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="d-flex">
														<a href="javascript:void(0);" class="btn btn-primary shadow btn-xs btn-square me-1"><i class="fas fa-pencil-alt"></i></a>
														<a href="javascript:void(0);" class="btn btn-danger shadow btn-xs btn-square"><i class="fa fa-trash"></i></a>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td>2011/07/25</td>
												<td>
													<span class="badge bg-secondary">Re-Open</span>
												</td>
												<td>
													<a href="javascript:void(0)" class="btn btn-outline-primary btn-xs">Assign</a>
												</td>
