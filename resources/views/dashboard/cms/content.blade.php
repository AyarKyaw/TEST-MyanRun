        ...
        <li class="breadcrumb-item active" aria-current="page">Content</li>
				...
				<div class="row">
					...
					<div class="col-xl-12">
						...
						<div class="mb-4">
							<a href="http://../cms/content-add.html" class="btn btn-primary">Add Content</a>
						</div>
						
						<div class="card card-collapse">
							<div class="card-header">
								<h4 class="card-title"><i class="fa-solid fa-file-lines me-1 text-primary"></i> Contact List</h4>
...
<!-- Mirrored from tixia-html.vercel.app/cms/content.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:11 GMT -->
</html>