...
<!-- End - Sidebar -->
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Add Email</li>
				...
				<div class="row">
					<div class="col-xl-12">
						<a href="cms/email-template.html" class="btn btn-primary mb-3">List Email Template</a>
					</div>
					<div class="col-xl-12">
						<div class="card card-collapse">
							<div class="card-header">
								<h4 class="card-title"><i class="fa-solid fa-envelope me-1 text-primary"></i> Add Email Template</h4>
									...
									<div class="row">
										...
										<div class="col-xl-6">
											...
											<div class="mb-3">
												...
												<div class="bg-light dz-scroll height140 p-3 rounded">
													...
													<div class="d-grid mb-3">
														<h6 class="mb-0">Generate Configuration</h6>
													...
													<div class="d-grid mb-3">
														<h6 class="mb-0">Contact Configuration</h6>
													...
													<div class="d-grid mb-3">
														<h6 class="mb-0">Order Configuration</h6>
										...
										<div class="col-xl-12">
											...
											<div class="form-check custom-checkbox mb-3">
												<input class="form-check-input" type="checkbox" id="checkboxDeactivation" required="">
												<label class="form-check-label" for="checkboxDeactivation">Active status template will use in email sending only.</label>
											</div>
											<div class="text-end">
