        ...
        <li class="breadcrumb-item active" aria-current="page">Email Template</li>
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="mb-4">
							<a href="cms/content-add.html" class="btn btn-primary">New Email Template</a>
						</div>
						<div class="card card-collapse">
							<div class="card-header">
								<h4 class="card-title"><i class="fa-solid fa-file-lines me-1 text-primary"></i>Email Template</h4>
