...
<!-- Mirrored from tixia-html.vercel.app/reports.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:39 GMT -->
				...
				<div class="row">
					...
					<div class="col-xl-3 col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<div id="chart" class="d-flex justify-content-center mb-3"></div>
								<div class="d-flex justify-content-center">
									<div class="mb-0 d-flex justify-content-center me-2">
										<span class="width20 height20 rounded-pill me-2 bg-warning"></span>	
										<div class="my-auto">
											<p class="fs-14 mb-0">Active</p>
										</div>
									</div>
									<div class="mb-0 d-flex justify-content-center me-2">
										<span class="width20 height20 rounded-pill me-2 bg-success"></span>	
										<div class="my-auto">
											<p class="fs-14 mb-0">Inactive</p>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-xl-3 col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<div id="chart2" class="mb-3 d-flex justify-content-center"></div>
								<div class="d-flex justify-content-center">
									<div class="mb-0 d-flex justify-content-center me-2">
										<span class="width20 height20 rounded-pill me-2 bg-warning"></span>	
										<div class="my-auto">
					...
					<div class="col-xl-6 col-md-6">
						<div class="card">
							...
							<div class="card-body d-flex">
								<div id="chart3" class="mb-md-0 mb-3"></div>
								<div class="align-self-center ms-3">
									<div class="mb-2 d-flex">
										<span class="width20 height20 rounded-pill me-2 bg-warning"></span>	
										<div>
											<p class="fs-14 mb-0">New</p>
										</div>
									</div>
									<div class="mb-2 d-flex">
										<span class="width20 height20 rounded-pill me-2 bg-success"></span>	
										<div>
											<p class="fs-14 mb-0">Inprogress</p>
										</div>
									</div>
									<div class="mb-2 d-flex">
										<span class="width20 height20 rounded-pill me-2 bg-info"></span>
										<div>
											<p class="fs-14 mb-0">On-Hold</p>
										</div>
									</div>
									<div class="mb-2 d-flex">
										<span class="width20 height20 rounded-pill me-2 bg-primary"></span>
										<div>
											<p class="fs-14 mb-0">Re-Open</p>
										</div>
									</div>
									<div class="mb-2 d-flex">
										<span class="width20 height20 rounded-pill me-2 bg-danger"></span>
										<div>
											<p class="fs-14 mb-0">Closed</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card-header">
							 ...
							 <div class="card-body">
								 <div class="table-responsive ticket-table">
									<table id="example" class="display dataTablesCard" style="min-width: 845px">
										<thead>
											<tr>
												<th>S.No.</th>
												<th>Employee ID</th>
										...
										<tbody>
											<tr>
												...
												<td>						
													<div>
														<a href="#" class="h6">Timothy L. Brodbeck</a>
													</div>
												</td>
												<td>
												...
												<td>
													<span class="badge light badge-success">1</span>
												</td>
											...
											<tr>
												...
												<td>
													<span class="badge light badge-success">5</span>
												</td>
											...
											<tr>
												...
												<td>
													<span class="badge light badge-success">2</span>
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>
													<span class="badge light badge-success">4</span>
												</td>
											...
											<tr>
												...
												<td>
													<span class="badge light badge-success">20</span>
												</td>
											</tr>
											<tr>
												...
												<td>
													<span class="badge light badge-success">30</span>
												</td>
...
<!-- End - Footer -->
	...
	<!-- Script For Reports Chart -->
	<script src="assets/js/dashboard/report.js"></script>

	<!-- Script for Apex Chart -->
	<script src="assets/vendor/apexcharts/dist/apexcharts.min.js"></script>
	
	<!-- Script For Datatables -->
	<script src="assets/vendor/datatables/js/jquery.dataTables.bundle.min.js"></script>
...
<!-- Mirrored from tixia-html.vercel.app/reports.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Feb 2026 03:00:40 GMT -->
</html>