            ...
            <div class="widget-event">
                <div class="item wow fadeInUp animated">
                    <div class="event-infomation">
                        ...
                        <img decoding="async" src="images/home_banner/Home Banner (2).JPG" alt="denpasar marathon event 2023">
                    </div>
                ...
                <div class="item wow fadeInUp animated">
                    <div class="event-infomation">
                        ...
                        <img decoding="async" src="images/home_banner/Run2.JPG" alt="denpasar marathon event 2023">
                    </div>
                    <div class="tf-info-price">
                        <h4>Ticket</h4>
                        <p class="price">
                ...
                <div class="item wow fadeInUp animated">
                    <div class="event-infomation">
                        ...
                        <img decoding="async" src="images/local1.jpg" alt="denpasar marathon event 2023">
                    </div>
                    <div class="tf-info-price">
                        <h4>Ticket</h4>
                        <p class="price">
                ...
                <div class="item wow fadeInUp animated">
                    <div class="event-infomation">
                        ...
                        <img decoding="async" src="images/home_banner/Run(F)1.jpeg" alt="denpasar marathon event 2023">
                    </div>
                    <div class="tf-info-price">
                        <h4>Ticket</h4>
                        <p class="price">
                ...
                <div class="item wow fadeInUp animated">
                    <div class="event-infomation">
                        ...
                        <img decoding="async" src="images/home_banner/Run(F)2.JPG" alt="denpasar marathon event 2023">
                    </div>
                    <div class="tf-info-price">
                        <h4>Ticket</h4>
                        <p class="price">
            ...
            <a href="https://tikkat.com.mm/detail/runderful-communityrun2026" target="_blank" class="flat-button">BUY NOW</a>
                ...
                <div class="item wow fadeInUp animated">
                    <div class="event-infomation">
                        ...
                        <img decoding="async" src="images/home_banner/Run(F)3.JPG" alt="denpasar marathon event 2023">
                    </div>
                    <div class="tf-info-price">
                        <h4>Ticket</h4>
                        <p class="price">
