    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-footer border-0 bg-light p-4">
                <button type="button" class="btn btn-outline-secondary px-4 py-2 w-100" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // 1. Search Logic (Keep as is, this is useful for Agents)
    if (searchInput) {
    ...
    // 2. View Details Logic (Locked to Read-Only)
    ...
    detailButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            document.getElementById('modal-tshirt-container').innerText = data.t_shirt_size || 'N/A';
            document.getElementById('modal-id-container').innerText = athlete.id_number || 'N/A';
